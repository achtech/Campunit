<div id="myModal" class="modal">
    ...
    <div class="modal-content" style="background: #f4f4f4;">
        ...
        <div class="modal-body">
                <div class="container">
                    {{ Form::open(['action'=>'App\Http\Controllers\ClientController@doLogin', 'enctype'=>'multipart/form-data','autocomplete'=>'off','method'=>'POST']) }}
                            ...
                            <div id="registerWithEmail" class="modal">
                                <div class="modal-content" style="background: #f4f4f4;margin-top: 82px;">
                                    ...
                                    <div class="titles-container">
                                        ...
                                        {{ Form::open(['action'=>'App\Http\Controllers\ClientController@store', 'enctype'=>'multipart/form-data','autocomplete'=>'off','method'=>'POST']) }}
